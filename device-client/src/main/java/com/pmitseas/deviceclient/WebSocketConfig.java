...
public class WebSocketConfig {
    ...
    public StompSession initSession(String username, String password) throws Exception {
        ...
        System.out.println("the connect headers are "+headers.toString());
        return enableSSL ?
    ...
    public WebSocketStompClient stompClient() {
        ...
        List<Transport> tList = Arrays.asList(new WebSocketTransport(simpleWebSocketClient));
        List<Transport> transports = Collections.unmodifiableList(tList);
